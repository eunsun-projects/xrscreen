...
class PointerLockControls extends EventDispatcher {
    ...
    onMouseMove(event) {
        ...
        this.updatePositionMouse(movementX, movementY, 0.002) //0.002
    }

    updatePositionMouse(movementX, movementY, multiplier) {
    ...
    connect() {
        ...
        this.domElement.ownerDocument.addEventListener("pointerlockchange", this.onPointerlockChangeBind)
    ...
    disconnect() {
        ...
        this.domElement.ownerDocument.removeEventListener("pointerlockchange",this.onPointerlockChangeBind)
        this.domElement.ownerDocument.removeEventListener("pointerlockerror",this.onPointerlockErrorBind)
    }
    ...
    lock() {
        if (typeof this.domElement.requestPointerLock !== "undefined") this.domElement.querySelector('canvas').requestPointerLock()
    }
